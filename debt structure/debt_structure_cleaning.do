...
twoway line dd1q_med compustat_dt if QUINTILEdec_BtM==1 & !mi(dd1q_med), lw(thin) lc(navy) || line dd1q_med compustat_dt if QUINTILEdec_BtM==5 & !mi(dd1q_med), lw(thin) lc(dkorange) xlabel(#4, labs(small)) xtitle("Date", size(medsmall)) ytitle("Long-term debt due in 1 Year (quarterly, in M$)", size(medsmall)) title("Long-term Debt Due in 1 Year: Median",size(medlarge)) legend(order(1 "Firms in the lowest BtM portfolio" 2 "Firms in highest BtM portfolio") size(small)) note("(BtM-sorted quintile portfolios are built following Fama and French (1992))") saving("${figdir}/1port/dd1q_2.gph", replace)
...
twoway line dd1q_mean compustat_dt if BtM_big==0 & !mi(dd1q_mean), lw(thin) lc(navy) || line dd1q_mean compustat_dt if BtM_big==1 & !mi(dd1q_mean), lw(thin) lc(dkorange) xlabel(#4, labs(small)) xtitle("Date", size(medsmall)) ytitle("Long-term debt due in 1 Year (quarterly, in M$)", size(medsmall)) title("Long-term Debt Due in 1 Year: Average",size(medlarge)) legend(order(1 "Firms in 2 lower BtM portfolios" 2 "Firms in 2 higher BtM portfolios") size(small)) note("(BtM-sorted quintile portfolios are built following Fama and French (1992))") saving("${figdir}/2port/dd1q_1.gph", replace)
...
twoway line dd1q_med compustat_dt if BtM_big==0 & !mi(dd1q_med), lw(thin) lc(navy) || line dd1q_med compustat_dt if BtM_big==1 & !mi(dd1q_med), lw(thin) lc(dkorange) xlabel(#4, labs(small)) xtitle("Date", size(medsmall)) ytitle("Long-term debt due in 1 Year (quarterly, in M$)", size(medsmall)) title("Long-term Debt Due in 1 Year: Median",size(medlarge)) legend(order(1 "Firms in 2 lower BtM portfolios" 2 "Firms in 2 higher BtM portfolios") size(small)) note("(BtM-sorted quintile portfolios are built following Fama and French (1992))") saving("${figdir}/2port/dd1q_2.gph", replace)
...
gr combine dd1q_1.gph dd1q_2.gph, rows(1) cols(2) imargin(medlarge) xsize(12) ysize(5) title("Long-term Debt Due in 1 Year: Firms in the Highest versus Lowest 2 BtM Quintiles") saving("${figdir}/2port/dd1q.gph", replace)
